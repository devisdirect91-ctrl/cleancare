...
export function buildPaywallProps(
  ...
  return {
    ...
    hydrationLevel: typeof fullResult.hydration_level === 'number' ? fullResult.hydration_level : null,
    textureScore: typeof fullResult.texture_score === 'number' ? fullResult.texture_score : null,
    concerns: concerns.map((concern) => getConcernInfo(concern).label),
    observation: typeof fullResult.recommendations_summary === 'string' ? fullResult.recommendations_summary : null,
